        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ForumPost_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ForumComment_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumEmotion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ForumEmotion_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ForumEmotion_ForumPost_PostId",
                        column: x => x.PostId,
                        principalTable: "ForumPost",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumComment_AccountId",
                table: "ForumComment",
                column: "AccountId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumEmotion_AccountId",
                table: "ForumEmotion",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ForumEmotion_PostId",
                table: "ForumEmotion",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_ForumPost_AccountId",
                table: "ForumPost",
                column: "AccountId");
